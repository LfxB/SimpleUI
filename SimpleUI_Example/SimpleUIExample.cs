    ...
    public class SimpleUIExample : Script
    {
        ...
        void InitMenu()
        {
            ...
            mainMenu.OnItemSelect += (sender, selectedItem, index) =>
            {
                ...
                {
                    GTA.UI.Notification.Show("Hi! I'm testing SimpleUI's OnItemSelect event!");
                }
                ...
                else if (selectedItem == itemAddPerson)
                {
                    ...
                    GTA.UI.Notification.Show(fname + " " + lname + " added to list!");
                }
                else if (selectedItem == itemRemoveLastPerson)
                {
                    if (testListAdvanced.Count > 1)
                    {
                        GTA.UI.Notification.Show(testListAdvanced[testListAdvanced.Count - 1].ToString() + " removed from list!");
                    ...
                    {
                        GTA.UI.Notification.Show("There is only one person left!");
                    }
                }
            };
            ...
            subMenu.WhileItemHighlight += (sender, selectedItem, index) =>
            {
                ...
                {
                    GTA.UI.Notification.Show("Highlighting subMenu's Item 1");
                }
                else if (selectedItem == submenuItem2)
                {
                    GTA.UI.Notification.Show("Highlighting subMenu's Item 2");
                }
            };
        ...
        private void MainMenu_OnItemLeftRight(UIMenu sender, UIMenuItem selectedItem, int index, UIMenu.Direction direction)
        {
            ...
            if (selectedItem == itemIntegerControl)
            {
                ...
                GTA.UI.Notification.Show("You pressed " + (direction == UIMenu.Direction.Left ? "Left" : "Right") + " while highlighting Integer Item!");
            }
            else if (selectedItem == itemFloatControl)
            {
                ...
                GTA.UI.Notification.Show("You pressed " + (direction == UIMenu.Direction.Left ? "Left" : "Right") + " while highlighting Float Item!");
            }
            else if (selectedItem == itemEnumControl)
            {
                ...
                GTA.UI.Notification.Show("You pressed " + (direction == UIMenu.Direction.Left ? "Left" : "Right") + " while highlighting Enum Item!");
            }
            else if (selectedItem == itemListControl)
            {
                // An item of type UIMenuListItem is automatically controlled by the menu.
                GTA.UI.Notification.Show("\"" + itemListControl.CurrentListItem.ToString() + "\" is selected.");
            }
            else if (selectedItem == itemListControlAdvanced)
            {
                ...
                GTA.UI.Notification.Show("\"" + itemListControlAdvanced.CurrentListItem.ToString() + "\" is selected.");
            }
        }
